...
Exchange 2026](https://epi.group/events/r-exchange-2026/yang-hu).

Due to the limited presentation time and the scope of the topic, it was
not possible to cover some important areas. This note serves as a quick
...
how to use packages. If your code is in a package, any R user can easily
download it, install it and learn how to use it.

But packages are useful even if you never share your code. Organising
code in a package makes your life easier because packages come with
conventions. For example, you put R code in `R/`, you put tests in
`tests/` and you put data in `data/`.
...
Why use R6? It becomes useful when your work moves beyond simple,
one-off data transformations into building systems with state and
layered logic. It allows you to bundle data and behaviour together, so
objects can update themselves instead of passing values through many
nested functions. This is especially helpful in projects like
simulations, projections, or Shiny apps, where components interact over
time. For small, stateless tasks it’s unnecessary—but for complex,
interdependent workflows, it makes code much easier to organise and
maintain.
...
possible—and even recommended. It is easier to start with golem than to
refactor your codebase later.
...
Fira Code is a free monospaced font with ligatures for common
programming multi-character combinations. This is purely a visual
